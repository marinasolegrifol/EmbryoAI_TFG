...
TRAIN_XLSX = r"C:\Users\oriol\Desktop\TFG_Marina\train.xlsx"
TEST_XLSX = r"C:\Users\oriol\Desktop\TFG_Marina\test.xlsx"
MODEL_PATH = r"C:\Users\oriol\PycharmProjects\EmbryoAI\efficientnet\model_en.pth"
OUTPUT_DIR = r"C:\Users\oriol\Desktop"
...
}).to_excel(os.path.join(OUTPUT_DIR, "predictions_en.xlsx"), index=False)

pd.DataFrame(report).transpose().to_excel(
    os.path.join(OUTPUT_DIR, "metrics_en.xlsx")
)

pd.DataFrame(cm, index=classes, columns=classes).to_excel(
    os.path.join(OUTPUT_DIR, "confusion_matrix_en.xlsx")
)
